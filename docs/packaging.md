...
```sh
xcrun notarytool submit Zeus-Tools-0.1.0-macOS-arm64.dmg \
  --keychain-profile ZEUS_NOTARY --wait
xcrun stapler staple Zeus-Tools-0.1.0-macOS-arm64.dmg
spctl --assess --type open --context context:primary-signature -v Zeus-Tools-0.1.0-macOS-arm64.dmg
```
