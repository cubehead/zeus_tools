...
| P0 | 剩余输入与 IME 验证 | Windows 11 中文 IME、emoji 与组合字符已通过；macOS 已验证 UTF-8 文件输入、中文/日文/韩文、emoji、组合字符、全选、复制、剪切、粘贴、撤销和重做。系统简体拼音的预编辑、首候选选择和中文提交已在窗口与全屏模式通过，组合提交前结果保持为空；候选面板相对插入光标的几何位置仍需人工全屏视觉确认，并需完成 Windows 10 复验。 |
