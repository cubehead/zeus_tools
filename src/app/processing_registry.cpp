...
const std::vector<Action> kActions = {
    ...
    {Mode::Auto, Kind::MongoShell, Label::Format, 64.0f},
    {Mode::JsonMinify, Kind::MongoShell, Label::Minify, 62.0f},
    {Mode::JsonEscape, Kind::MongoShell, Label::Escape, 62.0f},
    {Mode::JsonToYaml, Kind::MongoShell, Label::ToYaml, 68.0f},
    {Mode::JsonToXml, Kind::MongoShell, Label::ToXml, 62.0f},
    {Mode::JsonToCsv, Kind::MongoShell, Label::ToCsv, 62.0f, false, false, true},
    {Mode::JsonToToml, Kind::MongoShell, Label::ToToml, 72.0f},
...
const std::vector<InputTypeDefinition> kInputTypes = {
    ...
    {"mongodb", Mode::MongoShell, Kind::MongoShell},
...
constexpr std::array<ContentDefinition, static_cast<std::size_t>(Kind::Count)>
    kContentDefinitions{{
        ...
        {Kind::MongoShell, "MongoDB", "MongoDB", ".json", Syntax::Plain},
